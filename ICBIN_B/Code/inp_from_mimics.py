...
if __name__ == "__main__":
    ...
    parser.add_argument('--sub', type=str, default='2205030M',help='pt id')
    ...
    parser.add_argument('--loads', type=str, default='100,200,300,400', help='comma separated loads (N)')
    parser.add_argument('--flip', type=str, default='0,0,0', help='comma separated flip condiiton')
    ...
    for file_idx, file in enumerate(files):
        ...
        new_file = directory+filename+'_new'+file_ext
        ...
        bend_load_node = None
        bend_value = float('inf')  # Initialize with a large number
